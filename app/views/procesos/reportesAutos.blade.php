	...
	<div class="col-md-12">
		<div class="box box-info widget-user-2 dark-theme">
			<div class="widget-user-header bg-white-light">
				...
				<h3 class="widget-user-username">Módulo de Reportes de Autos</h3>
			...
			<fieldset style="margin:6px">
				<div class="row" style="margin-bottom: 8px">
					...
					<div class="col-sm-2">
						<label class="pull-right">Etapa del Auto:</label>
					</div>
					<div class="col-sm-4">              
				...
				<div class="row" style="margin-bottom: 8px">
					<div class="col-sm-2">
						<label class="pull-right">Vigencia del Proceso:</label>
					</div>
					<div class="col-sm-4">              
						{{''; $vigenciaActual = date("Y");}}  
						<select class="form-control transparente" id="vigencia" style="width:100%; margin:4px 0;">
					...
					<div class="col-sm-2">
						<label class="pull-right">Vigencia del Auto:</label>
					</div>
					<div class="col-sm-4">              
						{{''; $vigenciaActual = date("Y");}}  
						<select class="form-control transparente" id="vigenciaAuto" style="width:100%; margin:4px 0;">
                            <option value='0'>Todas las vigencias</option>
                            <?php 
                                for ($i=2014; $i<=$vigenciaActual; $i++) 
                                {
									if ($vigenciaActual == date("Y")) 
									{
				...
				<div class="row" style="margin-top:10px">
					...
					<div class="col-sm-4">
						<select class="form-control transparente" id="estado" style="width:100%; margin:4px 0;">
							<option value='2' selected>Todos los estados</option>
					...
					<div class="col-sm-6">
						<button class="btn btn-info pull-right" onclick="ejecutarReporte(1)">
							<i class="fa fa-bolt"></i> Ejecutar Consulta Autos
						</button>
					</div>
				</div>
			</fieldset>
			        ...
			        <div class="table-responsive">
        				<table class="table-dark table-striped">
							<thead id="headerReporte">
								<tr>
									<th></th>
									<th scope="col" style="width:3%">Auto</th>
...
<!--scriptsFin-->
@section('scriptsFin') 
<script src="{{asset('js/procesos/reportesAutos.js?v=').rand(1,100)}}"></script>
