...
<ol class="breadcrumb">
	...
	<li class="active">Subir Archivos Externos</li>
</ol>
<!--  #MIGA DE PAN -->
@stop
<!--# miga de pan-->
			...
			<div class="row">	
				<div class="col-md-8 col-md-offset-2">
					...
					<ul class="list-group list-group-unbordered">
						...
						<li class="list-group-item">							
							<fieldset>
								<h3><i class="fa fa-file-pdf-o"></i> Archivo externo </h3>
							    ...
							    <div class="row">
							      	<div class="col-xs-12">      
							        	<form action = "javascript:;" enctype="multipart/form-data" id="formularioExterno" class="form-horizontal">
							            	<div class="form-group">
							              		<div class="col-md-12">  
							                		<input type="file" class="file" data-preview-file-type="any" id="archivoExterno" name="archivoExterno" accept="application/pdf">
							              		</div>                                           
							            	</div>
							        	</form>
							      	</div>
							...
							<button type="button" class="btn btn-info pull-right" style="margin:22px 0 4px 0;" onclick="validarSubirExterno()"><li class="fa fa-cloud-upload" style="color:#fff;"></li> Confirmar</button>						
						</li>
					</ul>
				</div>
			</div>
...
function seleccionadoProceso(proceso)
{
	...
	$("#proceso").val(proceso);
	$("#archivoExterno").focus();  
}

function validarSubirExterno()
{
	...
	if(proceso == "")
	{
  	...
  	var fileArchivoExterno = document.getElementById("archivoExterno").value; 
  	
  	if(fileArchivoExterno == "")
  	{
  	...
  	var formData = new FormData($("#formularioExterno")[0]); 
    formData.append("proceso", proceso);
  
  	var ruta = "{{URL::to('procesos/subirArchivoExterno/')}}";
