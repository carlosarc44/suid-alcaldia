...
<!--miga de pan-->
@section('migaPan')   
<h1>TODAS LAS QUEJAS <small><span id="tituloFecha">recibidas durante la vigencia {{date("Y")}}</span></small></h1>
<!--  MIGA DE PAN -->
<ol class="breadcrumb">
	<li><a href="{{asset('/inicio')}}"><i class="fa fa-home"></i> Inicio</a></li>
	<li class="active">Quejas Recibidas por Vigencia</li>
</ol>
<!--  #MIGA DE PAN -->
@stop
<!--# miga de pan-->
...
{ 
    ...
    var ruta = "{{URL::to('quejas/traerQuejasTodas/')}}";
