@if(count($quejas) > 0)		
    <div class="row">
        <div class="col-sm-3">
            <div style="background: #fff; padding:10px;border: 1px solid #e3e3e3;text-align:center">     
                <img src="{{asset('img/stat.png')}}" style="height: 300px">                         
            </div>
        </div>
        <div class="col-sm-9">
            <div style="background: #fff; padding:10px;border: 1px solid #e3e3e3">            
                <canvas id="grafica-1" height="68"></canvas>
            </div>
        </div>
    </div>
    <br>
    ...
    <div class="row">
        ...
        <div class="col-sm-2">   
            <a href="{{ asset('quejas/excel-estados-queja/'.$fechaInicio.'/'.$fechaFin.'/'.$cadenaVectorEstados) }}" class="btn btn-success pull-right" style="margin-top:0px;color:#fff">
