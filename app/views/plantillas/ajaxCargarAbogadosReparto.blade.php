                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mt-4">
                    <div class="card card-inverse card-info">
                        ...
                        <div class="card-footer">
                            <small>Haga clic para repartir</small>
                            <button class="btn btn-info float-right btn-sm" style="margin-top:6px" onclick="asignarProceso({{$abogado->idAbogado}})">Asignar proceso</button>
                        </div>
                    </div>
                </div>
            @endforeach  
