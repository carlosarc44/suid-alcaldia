    ...
    <div class="col-sm-12">
        ...
        <div class="box">
            <div class="box-body box-profile">
                <h3 class="profile-username text-center">Crear Quejoso</h3>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <a href="javascript: void(0)" class="btn btn-info pull-left" onclick="modificarQuejoso(0, 1)">
                            <b><i class="fa fa-save"></i> Guardar Quejoso</b>
                        </a>
                    </div>
                </div>                
            </div>
