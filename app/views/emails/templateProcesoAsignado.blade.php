                      ...
                      <td valign="top">
                        ...
                        <table border="0" cellpadding="20" cellspacing="0" width="100%">
                          <tr>
                            <td valign="top" class="bodyContent">
                              <div mc:edit="std_content00">
                                ...
                                Le informamos que en reparto le fue asignado el proceso <strong>{{$registros["radicado"]}}</strong> en la fase de juzgamiento.                                  
                              </div>
                            </td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td valign="top" class="bodyContent">
                              <div mc:edit="std_content00">
                                Etapa Actual: <strong>{{$registros["etapa"]}}</strong>
                              </div>
                            </td>
                          </tr>
                          <tr>
                                ...
                                <tr>
                                  <td valign="middle" class="templateButtonContent">
                                    <div mc:edit="std_content02">
                                      <a href="http://gestion.manizales.gov.co/suid/public/procesos/activos" target="_blank" style="color:#fff; text-decoration: none;">Ingresar al SUID</a>
                                    </div>
                                  </td>
                                </tr>
                              </table>
