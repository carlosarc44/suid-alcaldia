...
<head>
  ...
  {{''; $pathCabezote =  public_path().'//img/email6.png'; }}
  {{'';  $registros = json_decode($arreglo, true);}}
    <center>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateHeader">
                    <tr>
                      <td class="headerContent">
                        ...
                        <img src="<?php echo $message->embed($pathCabezote);?>" style="max-width:600px; margin-top: 20px;" id="headerImage campaign-icon" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext />
                          ...
                          <tr>
                            <td valign="top" class="bodyContent">
                              <div mc:edit="std_content00">
                                ...
                                <h3 class="h3">
                                  {{'';
                                        $nombresUsuario = $registros[0]["nombresDestinatario"];
                                        $nombre = explode(" ", $nombresUsuario);
                                  }}
                                  {{ ucfirst(strtolower($nombre[0])) }},
                                  </h3>
                                <strong>SUID</strong> le recuerda su agenda para hoy {{ Util::formatearFecha($fechaHoy) }}:
                              </div>
                            </td>
                          </tr>
                          <tr>
                            <td valign="top" style="padding-top:0; padding-bottom:0;">
                              <table border="0" cellpadding="3" cellspacing="0" width="100%" class="templateDataTable">
                                <tr>
                                  <th align="center" scope="col" valign="top" width="13%" class="dataTableHeading" mc:edit="data_table_heading00">
                                    Hora
                                  </th>
                                  <th align="center" scope="col" valign="top" width="13%" class="dataTableHeading" mc:edit="data_table_heading02">
                                    Proceso
                                  </th>
                                  <th align="center" scope="col" valign="top" width="26%" class="dataTableHeading" mc:edit="data_table_heading01">
                                    Asunto
                                  </th>
                                  <th align="center" scope="col" valign="top" width="50%" class="dataTableHeading" mc:edit="data_table_heading02">
                                    Descripción
                                  </th>
                                </tr>
                                ...
                                <tr>
                                  <td valign="middle" class="templateButtonContent">
                                    <div mc:edit="std_content02">
                                      <a href="http://gestion.manizales.gov.co/suid/" target="_blank" style="color:#fff; text-decoration: none;">Ver tareas en el SUID</a>
                                    </div>
                                  </td>
                                </tr>
                              </table>
                    ...
                    <td valign="top" class="footerContent">
                      ...
                      <table border="0" cellpadding="10" cellspacing="0" width="100%">
                        <tr>
                          <td valign="top">
                            <div mc:edit="std_footer">
                              <em>Copyright &copy; 2016 | SUID | Sistema Unificado de Investigaciones Disciplinarias
                                <br/>
