...
; (function($) {
    ...
    $.fn.bcalendar = function(option) {
        ...
        function quickadd2(start, end, isallday, pos) 
        { 
        ...
        { 
            var fechaInicio = dateFormat.call(start, "yyyy-M-d HH:mm");
            var fechaFinal = dateFormat.call(end, "yyyy-M-d HH:mm");

            var fechaSel = CalDateShow(start, end, !isallday, true);            

            showModal($('#modal'));

            var ruta = "agenda/mostrarAgendarTarea";
            ...
            $.ajax({                
                ...
                {
                  alert("Error.  Contacte al administrador (Cod.Error.1917)");
                }
            }); 
        }
